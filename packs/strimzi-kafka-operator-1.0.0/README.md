...
[Kubernetes](https://kubernetes.io/) in various deployment configurations.

See their [website](https://strimzi.io) for more details about the project.

**!!! IMPORTANT !!!**
**From Strimzi 1.0 on, we support only Kubernetes 1.29 and newer.**
