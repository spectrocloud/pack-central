...
This pack deploys the upstream `confidential-containers` umbrella Helm chart (v0.21.0, which bundles Kata Containers **3.31.0**) with default values. The chart is the officially recommended way to install CoCo and replaces the deprecated Confidential Containers operator.
...
- This chart version pins Kata Containers 3.31.0. Review the [CoCo release notes](https://github.com/confidential-containers/charts/releases) before upgrading across minor versions, as enabled shims and runtime class names can change.
...
- [confidential-containers/charts (v0.21.0)](https://github.com/confidential-containers/charts)
