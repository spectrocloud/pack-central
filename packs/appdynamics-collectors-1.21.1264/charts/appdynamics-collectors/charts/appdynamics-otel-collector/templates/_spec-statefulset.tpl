  ...
  resource/prometheus:
    attributes:
      ...
      - key: k8s.cluster.name
        value: {{ (include "appdynamics-otel-collector.cluster.name" .) | quote}}
        action: upsert
      - key: k8s.cluster.id
...
{{- $mergedConfig :=  mustMergeOverwrite $mergedConfig (include "appdynamics-otel-collector.agentManagementModeConfig" (dict "mode" "statefulset" "var1" .var1) | fromYaml) }}
