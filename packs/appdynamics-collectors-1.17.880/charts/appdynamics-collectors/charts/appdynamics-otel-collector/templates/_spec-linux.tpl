...
{{- $mergedConfig :=  mustMergeOverwrite $mergedConfig (include "appdynamics-otel-collector.agentManagementNameConfig" (dict "var1" .var1 "os" "" "type" "ds") | fromYaml ) }}
...
{{- $mergedConfig :=  mustMergeOverwrite $mergedConfig (include "appdynamics-otel-collector.agentManagementNameConfig" (dict "var1" .var1 "os" "" "type" "ss") | fromYaml ) }}
{{- with .var1.Values.env.linux.configOverride }}
{{- $mergedConfig := mustMergeOverwrite $mergedConfig (deepCopy .) }}
{{- end }}
