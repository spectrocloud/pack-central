...
{{- $mergedConfig :=  mustMergeOverwrite $mergedConfig (include "appdynamics-otel-collector.agentManagementNameConfig" (dict "var1" .var1 "os" "-win" "type" "ds") | fromYaml ) }}
...
{{- $mergedConfig :=  mustMergeOverwrite $mergedConfig (include "appdynamics-otel-collector.agentManagementNameConfig" (dict "var1" .var1 "os" "-win" "type" "ss") | fromYaml ) }}
{{- with .var1.Values.env.windows.configOverride }}
{{- $mergedConfig := mustMergeOverwrite $mergedConfig (deepCopy .) }}
{{- end }}
