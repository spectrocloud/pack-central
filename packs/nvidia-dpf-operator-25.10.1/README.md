...
This pack installs the Nvidia DPF Operator v25.10.1.

## Prerequisites

This pack should be used in conjunction with the Nvidia DPF Prereqs v25.10.1 pack, as the dependencies for the DPF Operator are no longer part of the DPF Operator itself. If you're deploying DPF clusters in Host-Trusted mode, you also need to combine this with the Nvidia OVN Kubernetes v25.10.1 CNI.
...
The deploy this pack in Zero-Trusted mode, deploy this operator and use the Zero Trust - Passthrough preset in the DPF Deployment 25.10.1 pack.
